...
export function TrustStrip() {
  return (
    <section className="px-5 pb-14 sm:px-8 sm:pb-20 lg:pb-24">
      <div className="relative z-10 mx-auto -mt-8 flex min-h-[201px] max-w-[80rem] items-center rounded-2xl border border-border bg-surface p-7 shadow-[0_12px_32px_-16px_rgba(16,24,38,0.18)] sm:-mt-10 sm:p-9">

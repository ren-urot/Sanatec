...
export function TrustStrip() {
  return (
    <section className="px-5 pb-14 sm:px-8 sm:pb-20 lg:pb-24">
      <div className="relative z-10 mx-auto -mt-8 max-w-[80rem] rounded-2xl border border-border bg-surface p-7 shadow-[0_12px_32px_-16px_rgba(16,24,38,0.18)] sm:-mt-10 sm:p-9">
        <div className="grid grid-cols-1 gap-8 sm:grid-cols-2 lg:grid-cols-4 lg:gap-6">
          {items.map(({ icon: Icon, title, body }) => (
            <div key={title} className="flex items-start gap-3.5">
              <span className="flex h-11 w-11 shrink-0 items-center justify-center rounded-full bg-accent-2-soft text-accent">
